        ...
        $(function() {
            ...
            function loadQuota(params) {
                if (table.length) {
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row) {
                                    return `<a href="/panel/data-sekolah/quota/edit/${data}" class="btn btn-primary">Lihat Detail</a>`;
                                }
                            },
                        ],
                    ...
                    $("div.add-button, div.add-button-sm").html('<a href="/panel/data-sekolah/quota/add" class="btn btn-success">+ Tambah Jurusan</a>');
