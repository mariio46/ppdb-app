                ...
                success: function(data) {
                    ...
                    if (d.sma != null && d.sma.length) {
                        ...
                        d.sma.forEach(sma => {
                            ...
                            var tab = generateTabContentHtml(n == 0, abb, sma.jalur, sma.info, start.getDate(), start.getMonth(), end.getDate(), end.getMonth(), end
                                .getFullYear(), isNotExpired, sma.slug);
                    ...
                    if (d.smk != null && d.smk.length) {
                        ...
                        d.smk.forEach(smk => {
                            ...
                            var tab = generateTabContentHtml(n == 0, abb, smk.jalur, smk.info, start.getDate(), start.getMonth(), end.getDate(), end.getMonth(), end
                                .getFullYear(), isNotExpired, smk.slug);
