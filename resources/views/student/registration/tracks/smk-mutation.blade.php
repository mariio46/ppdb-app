@extends('student.registration.tracks.track-base', ['typeSchool' => 'SMK', 'track' => 'Perpindahan Tugas Orang Tua'])
...
@section('school-choices')
  ...
  <x-student.registration-modal modalLevel="SMK" modalTrack="Perpindahan Tugas Orang Tua"></x-student.registration-modal>
@endsection
