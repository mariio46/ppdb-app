@extends('student.registration.tracks.track-base', ['typeSchool' => 'SMK', 'track' => 'Anak Guru'])
...
@section('school-choices')
  ...
  <x-student.registration-modal modalLevel="SMK" modalTrack="Anak Guru" withSchoolVerif="false"></x-student.registration-modal>
@endsection
