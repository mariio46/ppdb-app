...
@section('content')
  ...
  <div class="content-body mb-5">
    <div class="card">
      ...
      <form id="formEditScore" action="/personal-data/{{ $semester }}/update-score" method="post">
        @csrf
          ...
          <div class="row">
            <div class="col-md-4 col-xl-3 col-sm-12 border-md-end pe-0">
              <ul class="nav flex-column ps-2 d-none d-md-block">
                @for ($i = 1; $i <= 5; $i++)
                  <li class="nav-item mt-1">
                    <a class="nav-link {{ $semester == $i ? 'active' : '' }}" href="/data-diri/edit-nilai/semester-{{ $i }}">
              ...
              <ul class="nav nav-pills d-md-none align-items-center mt-1">
                ...
                @for ($j = 1; $j <= 5; $j++)
                  <div class="nav-item">
                    <a class="nav-link {{ $semester == $j ? 'active' : '' }}" href="/data-diri/edit-nilai/semester-{{ $j }}">{{ $j }}</a>
                  </div>
                @endfor
              </ul>
            </div>
        ...
        <div class="card-body pb-3">
          ...
          <a class="btn btn-outline-secondary" href="/data-diri" role="button">Batalkan</a>
        </div>
      </form>
    </div>
  </div>
