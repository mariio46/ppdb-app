...
class FaqModel
{
    public function getData()
    {
        return [
            [
                'question' => 'Apa syarat utama untuk mendaftar di sekolah ini?',
            ...
            [
                'question' => 'Bagaimana cara mengisi formulir pendaftaran online?',
            ...
            [
                'question' => 'Berapa biaya pendaftaran untuk sekolah ini?',
                'answer' => 'Biaya pendaftaran sekolah kami adalah Rp 500.000,- per peserta didik baru.',
            ],
            [
                'question' => 'Apakah tersedia beasiswa untuk peserta didik baru?',
            ...
            [
                'question' => 'Bagaimana proses seleksi peserta didik baru dilakukan?',
            ...
            [
                'question' => 'Bagaimana cara pembayaran biaya pendidikan?',
            ...
            [
                'question' => 'Apakah ada kegiatan ekstrakurikuler yang tersedia?',
            ...
            [
                'question' => 'Apakah sekolah ini memiliki fasilitas transportasi?',
            ...
            [
                'question' => 'Apa program unggulan yang ditawarkan oleh sekolah ini?',
            ...
            [
                'question' => 'Adakah bantuan beasiswa bagi siswa yang berprestasi?',
            ...
            [
                'question' => 'Bagaimana cara mengajukan izin ketidakhadiran?',
            ...
            [
                'question' => 'Apakah ada kegiatan khusus untuk memperkuat hubungan antara sekolah dan orang tua?',
            ...
            [
                'question' => 'Bagaimana cara mendapatkan informasi tentang kegiatan ekstrakurikuler?',
            ...
            [
                'question' => 'Apa persyaratan untuk mengikuti kegiatan belajar di luar negeri?',
            ...
            [
                'question' => 'Apakah ada kursus persiapan ujian nasional?',
            ...
            [
                'question' => 'Bagaimana prosedur jika ingin mengajukan saran atau keluhan?',
            ...
            [
                'question' => 'Apakah ada klub buku di sekolah ini?',
            ...
            [
                'question' => 'Apa fasilitas yang tersedia di perpustakaan sekolah?',
